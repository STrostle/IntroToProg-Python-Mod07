...
#   strostle,02/25/2024,Created Script
# ------------------------------------------------------------------------------------------ #
import json
...
class FileProcessor:
    ...
    strostle,02.25.2024,Created Class
    """
    @staticmethod
    def read_data_from_file(file_name: str, student_data: list):
        ...
        ChangeLog: (Who, When, What)
        strostle,02.25.2024,Created function
...
class Student(Person):
     ...
     An inherited class from person to take new student data
     """
     def __init__(self, first_name: str, last_name: str, course_name:str):
          super().__init__(first_name,last_name, course_name)
...
class IO:
    ...
    ChangeLog: (Who, When, What)
    strostle,02.25.2024,Created Class
    strostle,02.25.2024,Added menu output and input functions
    strostle,02.25.2024,Added a function to display the data
    strostle,02.25.2024,Added a function to display custom error messages
    """
    ...
    def output_error_messages(message: str, error: Exception = None):
        ...
        ChangeLog: (Who, When, What)
        strostle,1.3.2024,Created function
